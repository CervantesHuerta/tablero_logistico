	...
	*/
	class Wialon{
		...
		*/
		...
		public function avl_evts($sid)
		{
			$ch = curl_init();
			curl_setopt($ch, CURLOPT_URL, "https://hst-api.wialon.com/avl_evts?sid=" . $sid);
	...
	*/
	class WialonError{
		...
		public static $errors = array(
			...
			4 => 'Entrada no autorizada',
			5 => 'Error al realizar la solicitud',
			6 => 'Unknow error',
			7 => 'Error desconocido',
			8 => 'Usuario o contraseña no válidos',
			9 => 'El servidor de autorización no está disponible. Vuelve a intentarlo más tarde.',
			1001 => 'No hay mensaje para el intervalo seleccionado',
			1002 => 'El artículo con esa propiedad única ya existe',
			1003 => 'Sólo se permite una solicitud'
		);
		...
		public static function error($code = '', $text = ''){
			...
			return sprintf('SaktesiError( %s )', $message);
		}
	}